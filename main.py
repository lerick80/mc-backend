...
# Generar código único de invitado
...
def create_guest(
    ...
    return {"message": "Invitado creado", "code": code}
...
def confirm_guest(data: dict, db: Session = Depends(get_db)):
    ...
    if guest.guests_confirmed > 0:
        raise HTTPException(status_code=400, detail="Este invitado ya confirmó asistencia")
...
def export_excel(
    ...
    FRONT = "https://boda-carlos-magali.vercel.app"  # cámbialo cuando despliegues
